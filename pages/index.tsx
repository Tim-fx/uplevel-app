      ...
      <main className='bg-slate-900 h-screen'>
        <nav className="bg-slate-900 shadow">
          <div className="container flex items-center justify-center p-6 capitalize text-gray-300">
            ...
            <Link href="./login.html" className="relative border-b-2 border-transparent transition-colors duration-300 transform hover:text-gray-200 hover:border-green-500 mx-1.5 sm:mx-6">Login</Link>
        ...
        <section className="bg-gray-900 text-white">
          <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-lg text-center">
              <h2 className="text-3xl font-semibold sm:text-3xl">Choose Your <span className="text-green-500">Subject</span></h2>
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <a className="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
                ...
                <h2 className="mt-4 text-xl font-bold text-white">Matematika</h2>
              ...
              <a className="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
                ...
                <h2 className="mt-4 text-xl font-bold text-white">Biologi</h2>
